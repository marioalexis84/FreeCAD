...
void ViewProviderFemConstraintTransform::updateData(const App::Property* prop)
{
    ...
    //        RADIUSAXIS * pcConstraint->Scale.getValue();  // OvG: Calculate scaled values once
    //        only
    //    float scaledheightaxis = HEIGHTAXIS * pcConstraint->Scale.getValue();
    //    float scaledheadradiusA =
    //        ARROWHEADRADIUS * pcConstraint->Scale.getValue();  // OvG: Calculate scaled values
    //        once only
    ...
    //                createArrow(sep, scaledlengthA * 0.75, scaledheadradiusA * 0.9);  // OvG:
    //                Scaling pShapeSep->addChild(sep);
    //
    ...
    //                createArrow(sepx, scaledlengthA * 0.65, scaledheadradiusA * 0.65);  // OvG:
    //                Scaling pShapeSep->addChild(sepx);
    //
    ...
    //                createArrow(sepy, scaledlengthA * 0.65, scaledheadradiusA * 0.65);  // OvG:
    //                Scaling pShapeSep->addChild(sepy);
    //
    //                n++;
    //            }
    //        }
                                                         ...
                                                         SbMatrix& mat) const
{
    ...
    Base::Rotation rot = obj->RectangularTransform.getValue();
    Base::Vector3d axis;
    double angle;
