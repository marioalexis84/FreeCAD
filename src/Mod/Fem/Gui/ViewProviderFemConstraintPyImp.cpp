...
Py::Object ViewProviderFemConstraintPy::getSymbolTransform() const
{
    try {
        SoTransform* trans = getViewProviderFemConstraintPtr()->getSymbolTransform();
        PyObject* Ptr =
            Base::Interpreter().createSWIGPointerObj("pivy.coin", "_p_SoTransform", trans, 1);
