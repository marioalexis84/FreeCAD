...
"""
    ...
    def run_netgen(
        ...
        for items, l in mesh_region:
            for t, n in items:
                if t == "Vertex":
                    shape.vertexes[n - 1].maxh = l
                elif t == "Edge":
                    shape.edges[n - 1].maxh = l
                elif t == "Face":
                    shape.faces[n - 1].maxh = l
                elif t == "Solid":
                    shape.solids[n - 1].maxh = l
