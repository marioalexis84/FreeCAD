...
class _TaskPanel(base_femtaskpanel._BaseTaskPanel):
    ...
    def init_parameter_widget(self):
        ...
        self.parameter_widget.qsb_potential.setProperty("value", self.obj.Potential)
        FreeCADGui.ExpressionBinding(self.parameter_widget.qsb_potential).bind(
            self.obj, "Potential"
        )
        self.parameter_widget.ckb_potential.setChecked(self.obj.PotentialEnabled)

        # the vector potentials
        self.parameter_widget.qsb_av_re.setProperty("value", self.obj.Potential)
        FreeCADGui.ExpressionBinding(self.parameter_widget.qsb_av_re).bind(self.obj, "Potential")

        self.parameter_widget.qsb_av_re_1.setProperty("value", self.obj.AV_re_1)
        FreeCADGui.ExpressionBinding(self.parameter_widget.qsb_av_re_1).bind(self.obj, "AV_re_1")
        self.parameter_widget.qsb_av_re_2.setProperty("value", self.obj.AV_re_2)
        FreeCADGui.ExpressionBinding(self.parameter_widget.qsb_av_re_2).bind(self.obj, "AV_re_2")
        self.parameter_widget.qsb_av_re_3.setProperty("value", self.obj.AV_re_3)
        FreeCADGui.ExpressionBinding(self.parameter_widget.qsb_av_re_3).bind(self.obj, "AV_re_3")
        self.parameter_widget.qsb_av_im.setProperty("value", self.obj.AV_im)
        FreeCADGui.ExpressionBinding(self.parameter_widget.qsb_av_im).bind(self.obj, "AV_im")
        self.parameter_widget.qsb_av_im_1.setProperty("value", self.obj.AV_im_1)
        FreeCADGui.ExpressionBinding(self.parameter_widget.qsb_av_im_1).bind(self.obj, "AV_im_1")
        self.parameter_widget.qsb_av_im_2.setProperty("value", self.obj.AV_im_2)
        FreeCADGui.ExpressionBinding(self.parameter_widget.qsb_av_im_2).bind(self.obj, "AV_im_2")
        self.parameter_widget.qsb_av_im_3.setProperty("value", self.obj.AV_im_3)
        FreeCADGui.ExpressionBinding(self.parameter_widget.qsb_av_im_3).bind(self.obj, "AV_im_3")

        self.parameter_widget.ckb_av_re_1.setChecked(self.obj.AV_re_1_Disabled)
        self.parameter_widget.ckb_av_re_2.setChecked(self.obj.AV_re_2_Disabled)
        self.parameter_widget.ckb_av_re_3.setChecked(self.obj.AV_re_3_Disabled)
        self.parameter_widget.ckb_av_im.setChecked(self.obj.AV_im_Disabled)
        self.parameter_widget.ckb_av_im_1.setChecked(self.obj.AV_im_1_Disabled)
        self.parameter_widget.ckb_av_im_2.setChecked(self.obj.AV_im_2_Disabled)
        self.parameter_widget.ckb_av_im_3.setChecked(self.obj.AV_im_3_Disabled)

        self.parameter_widget.ckb_potential_constant.setChecked(self.obj.PotentialConstant)

        self.parameter_widget.ckb_electric_infinity.setChecked(self.obj.ElectricInfinity)

        self.parameter_widget.ckb_electric_forcecalculation.setChecked(
            self.obj.ElectricForcecalculation
        )

        self.parameter_widget.ckb_capacitance_body.setChecked(self.obj.CapacitanceBodyEnabled)
        self.parameter_widget.spb_capacitance_body.setValue(self.obj.CapacitanceBody)
